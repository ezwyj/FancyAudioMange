...
namespace Web.Controllers
{
    public class CommonController : Controller
    {
        ...
        public JsonResult UploadAttachment(string extra)
        {
            bool state = true;
            string msg = string.Empty;
            List<AttachmentEntity> fileList = new List<AttachmentEntity>();
            ...
            try
            {
                ...
                {
                    string dirPath = Util.CreateDirectory(AttachmentPath, true);
        ...
        {
            string msg = string.Empty;
            AttachmentEntity file = AttachmentEntity.GetSingle(id);
        ...
        public JsonResult DeleteAttachment(string instanceId, string type, string id)
        {
            ...
            if (file != null)
            {
                ...
                if (System.IO.File.Exists(file.FileAddress))
                {
        ...
        public JsonResult UploadFile()
        {
            ...
            try
            {
                ...
                {
                    string dirPath = Util.CreateDirectory(FilePath, false);
